...
\section{Question 2}
\subsection{1.}
After implementing the logistic regression with Pytorch, the best performing learning rate was 0.01.
Again here it looks like 20 training epochs was not enough to get the best performance out of the model.
